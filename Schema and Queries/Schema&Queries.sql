/*
    Creating database for instahyre Project
*/
...
-- Creating Table to store companies data
DROP TABLE Company;
...
--Creating table to store the Details require by the company
DROP TABLE Details;
...
--Creating table to store the data of Job Openings
DROP TABLE Jobs;
CREATE TABLE Jobs
(
...
--Creating a relationship table between the Company and Locations in which they are offering the jobs
DROP TABLE COM_LOC;
...
--Creating a relationship table between the Details and the SKILLS 
...
--Creating a table as per our standard Role
...
-- Creating a view to  show all the details that was scrapped from the website 
